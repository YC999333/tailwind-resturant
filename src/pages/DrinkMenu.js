...
function DrinkMenu() {
  return (
    <div className='bg-gray-100 text-white px-20 md:px-36 py-8 bg-center bg-contain sm:bg-cover text-shadow bg-drink-image'>
      ...
      <div className='grid place-items-center p-2 grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-2 xl:gap-6 mt-8'>
        ...
        <div className='text-center text-xl md:text-2xl max-w-md w-10/12 p-2 rounded-lg'>
          ...
          <p className='p-2 text-sm'>mezcal, aperol, pineapple, lemon</p>
          <p className='p-2'>$150</p>
        </div>
        <div className='text-center text-xl md:text-2xl max-w-md w-10/12 p-2 rounded-lg'>
          <p className='p-2'>Atomic Old Fashioned</p>
          <p className='p-2 text-sm'>eagle rare single bourbon, bitters, sugar</p>
          <p className='p-2'>$150</p>
        </div>
        <div className='text-center text-xl md:text-2xl max-w-md w-10/12 p-2 rounded-lg'>
          <p className='p-2'>Paloma</p>
          <p className='p-2 text-sm'>reposado tequila, grapefruit, lime, tonic, salt</p>
          <p className='p-2'>$150</p>
        </div>
      </div>
      <p className='text-center mb-30 uppercase underline text-2xl mt-20'>
