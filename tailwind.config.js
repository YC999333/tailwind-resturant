  ...
  theme: {
    extend: {
      backgroundImage: (theme) => ({
        ...
        'main-image':
          "linear-gradient(rgba(9,2,19, 0.6), rgba(9,2,19, 0.6)),url('https://upload.cc/i1/2021/05/14/GRBrXK.jpg')",
        'drink-image':
          "linear-gradient(rgba(9,2,19, 0.6), rgba(9,2,19, 0.6)),url('https://upload.cc/i1/2021/05/14/EoOKdD.jpg')",
      }),
    },
  },
  variants: {
